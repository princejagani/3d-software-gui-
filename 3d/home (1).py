...
############################################ all function ####################################################################
    def change(self):
        ...
        a=import_module.Ui_Form()
        a.setupUi(Form,self.main_widget,self.gridLayout_4,self.main_grid_Layout,self.main_2_horizontalLayout,self.verticalLayout)
    def imports(self):
        f=open()
...
"")
        ...
        self.home_btn.clicked.connect(self.change)
...
############################################### cat widget ############################################################################
        ...
        self.cat_widget.setStyleSheet("background-color: rgb(85, 255, 127);")
        ...
        self.scroll_cat.setVerticalScrollBarPolicy(Qt.ScrollBarAlwaysOn)
        self.scroll_cat.setHorizontalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
        self.scroll_cat.setWidgetResizable(True)
        self.scroll_cat.setStyleSheet("background-color: rgb(36, 36, 36);")
...
############################################### std widget ############################################################################
        ...
        self.scroll_std.setVerticalScrollBarPolicy(Qt.ScrollBarAlwaysOn)
        self.scroll_std.setHorizontalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
        self.scroll_std.setWidgetResizable(True)
        self.scroll_std.setStyleSheet("background-color: rgb(36, 36, 36);")
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.history_btn_2.setText(_translate("Form", " Resent"))
